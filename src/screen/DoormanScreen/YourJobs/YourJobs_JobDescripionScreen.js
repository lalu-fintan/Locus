...
const YourJobs_JobDescripionScreen = ({navigation, route}) => {
  return (
    <SafeAreaView>
      <ScrollView>
        <TopLogo
        ...
        <View>
          <View style={styles.bodyContainer}>
              ...
              <View style={styles.timeContainer}>
                <View style={styles.date}>
                  <CalenderIcon
                    ...
                    color={'#8B8A8A'}
                  />
                  <Text style={styles.dateTxt}>{route.params?.eventDate}</Text>
                </View>
                <View style={styles.time}>
                  <TimeIcon name="time" size={16} color={'#4FC762'} />
                  <Text style={styles.timeTxt}>
                    From {route.params?.Timing}
                  </Text>
                </View>
              </View>
            </View>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.checkBtnTxt}>CHECK IN/OUT</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
...
export default YourJobs_JobDescripionScreen;
